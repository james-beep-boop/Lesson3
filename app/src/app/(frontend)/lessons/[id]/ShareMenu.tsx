...
/**
 * Share ▾ — the lesson page's one menu for whole-version share/export actions (declutter L2,
 * 2026-07-15): Download all as Word/PDF .zips (SPEC §9 two-phase export → `downloadExport`),
 * Email… (SPEC §10 — the compose form is the composed `EmailModal`), and Message a colleague (§10
 ...
 * email compose form to `EmailModal` (which owns its own recipient/sending/error state).
 *
      ...
      {open && (
        <div className="share-menu">
          ...
          <p className="share-menu__note">
            All four act on this version{semver ? ` (${semver})` : ''}.
          </p>
        </div>
      )}
      {busyText && (
