 ...
 * the risky half of the 2026-07-25 current-lesson indicator: the DOM plumbing (scroll + ResizeObserver,
 * toolbar measurement) is browser-verified, but the "which section am I in" decision is pinned here.
 *
